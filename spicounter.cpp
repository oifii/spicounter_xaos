...
TCHAR szTitle[1024]={L"spicountertitle"};					// The title bar text
TCHAR szWindowClass[1024]={L"spicounterclass"};			// the main window class name
                     ...
                     int       nCmdShow)
{
	...
	//ShellExecuteA(NULL, "open", "begin.ahk", "", NULL, nCmdShow);
	ShellExecuteA(NULL, "open", global_begin.c_str(), "", NULL, nCmdShow);
	//ShellExecuteA(NULL, "open", "starting.ahk", "", NULL, nCmdShow);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_DESTROY:
		...
		KillTimer(hWnd, 1);
		//ShellExecuteA(NULL, "open", "end.ahk", "", NULL, 0);
